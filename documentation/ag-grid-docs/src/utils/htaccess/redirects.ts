...
export const SITE_301_REDIRECTS: Redirect[] = [
    ...
    { from: '/javascript-data-grid/themes', to: '/javascript-data-grid/theming' },
    { from: '/angular-data-grid/themes', to: '/javascript-data-grid/theming' },
    { from: '/react-data-grid/themes', to: '/javascript-data-grid/theming' },
    { from: '/vue-data-grid/themes', to: '/javascript-data-grid/theming' },
